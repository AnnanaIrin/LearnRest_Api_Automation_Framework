...
public class Tweet extends RestBase {
   ...
   //https://developer.twitter.com/en/docs/twitter-api/v1/tweets/timelines/api-reference/get-statuses-user_timeline
    ...
    public static final String GET_USER_TWEET_ENDPOINT="/statuses/home_timeline.json";//this is api end point
   ...
   //Get All Tweet information
    public ValidatableResponse getUserTimeLineTweet(){
        //Note:
        //given is a method, auth is a method(we used oauth authentication), when is a method and status code is a verification
